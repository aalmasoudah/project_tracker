...
urlpatterns = [
    ...
    path("me/avatar/", views.profile_avatar_update, name="avatar_update"),
    path("me/avatar/remove/", views.profile_avatar_remove, name="avatar_remove"),
    path("users/<int:user_id>/avatar/", views.profile_avatar_image, name="avatar"),
